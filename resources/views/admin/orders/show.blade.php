...
@section('admin-content')
    ...
    <div class="d-flex">
        <div class="card shadow  p-0 col-8 mb-4 mr-2">
            <div class="card-header py-3 d-flex">
                <h6 class="font-weight-bold text-primary mt-2">Order ({{ $order->ref_id }})</h6>
                <div class="ml-auto">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>{{ $order->ref_id }}</td>
                                <th>Customer</th>
                                <td><a href="{{ route('admin.customers.show', $order->user_id) }}">{{ $order->user->username }}</a></td>
                            </tr>
                            <tr>
                                <th>Address</th>
