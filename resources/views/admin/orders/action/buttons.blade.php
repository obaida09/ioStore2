<a href="{{ route('admin.orders.edit', $id) }}" class="btn btn-primary btn-table btn-sm">
...
<form action="{{ route('admin.orders.destroy', $id) }}" method="post" id="delete-product-category-{{ $id }}" class="d-none">
@csrf
@method('DELETE')
</form>