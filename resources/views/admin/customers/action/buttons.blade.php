<a href="{{ route('admin.customers.edit', $id) }}" class="btn btn-primary btn-table btn-sm">
...
<form action="{{ route('admin.customers.destroy', $id) }}" method="post" id="delete-product-category-{{ $id }}" class="d-none">
@csrf
@method('DELETE')
</form>