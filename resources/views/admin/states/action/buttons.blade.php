<a href="{{ route('admin.states.edit', $id) }}" class="btn btn-primary btn-table btn-sm">
...
<form action="{{ route('admin.states.destroy', $id) }}" method="post" id="delete-product-category-{{ $id }}" class="d-none">
@csrf
@method('DELETE')
</form>