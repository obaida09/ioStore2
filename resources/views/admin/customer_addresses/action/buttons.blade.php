<a href="{{ route('admin.customer_addresses.edit', $id) }}" class="btn btn-primary btn-table btn-sm">
...
<form action="{{ route('admin.customer_addresses.destroy', $id) }}" method="post" id="delete-product-category-{{ $id }}" class="d-none">
@csrf
@method('DELETE')
</form>