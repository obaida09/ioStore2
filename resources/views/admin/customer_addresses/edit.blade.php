                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <select name="default_address" class="form-control">
                            <option value="0" {{ old('default_address', $customer_address->default_address) == '0' ?
                                'selected' : null }}>No</option>
                            <option value="1" {{ old('default_address', $customer_address->default_address) == '1' ?
                                'selected' : null }}>Yes</option>
                        </select>
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <select name="country_id" id="country_id" class="form-control">
                            ...
                            <option value="{{ $country->id }}" {{ old('country_id', $customer_address->country_id) ==
                                $country->id ? 'selected' : null }}>{{ $country->name }}</option>
                            @empty
                            @endforelse
                        </select>
...
@push('js')
<script src="{{ asset('admin/vendor/typeahead/bootstrap3-typeahead.min.js') }}"></script>
<script>
    $(function () {
            populateStates();
            populateCities();
            ...
            function populateStates()
            {
                ...
                $.get("{{ route('admin.get_states') }}", {country_id: countryIdVal}, function (data) {
            ...
            function populateCities()
            {
                ...
                $.get("{{ route('admin.get_cities') }}", {state_id: stateIdVal}, function (data) {
