<a href="{{ route('admin.product_reviews.edit', $id) }}" class="btn btn-primary btn-table btn-sm">
...
<form action="{{ route('admin.product_reviews.destroy', $id) }}" method="post" id="delete-product-category-{{ $id }}" class="d-none">
@csrf
@method('DELETE')
</form>