...
@push('css')
<link rel="stylesheet" href="{{ asset('admin/vendor/datepicker/themes/classic.css') }}">
<link rel="stylesheet" href="{{ asset('admin/vendor/datepicker/themes/classic.date.css') }}">
<style>
...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex">
        <h6 class="m-2 font-weight-bold text-primary">Edit coupon ({{ $productCoupon->code }})</h6>
        <div class="ml-auto">
            <a href="{{ route('admin.product_coupons.index') }}" class="btn btn-primary btn-sm">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    ...
                    <select name="type" class="form-control">
                        ...
                        <option value="percentage" {{ old('type', $productCoupon->type) == 'percentage' ? 'selected' :
                            null }}>Percentage</option>
                    </select>
...
@push('js')
<script src="{{ asset('admin/vendor/datepicker/picker.js') }}"></script>
<script src="{{ asset('admin/vendor/datepicker/picker.date.js') }}"></script>
<script>
    $(function(){
            $('#code').keyup(function () {
