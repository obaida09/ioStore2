            ...
            <div class="col-lg-8 pt-2">
                <form action="{{ route('frontend.customer.update_profile') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 form-group mt-4">
                            <label class="text-small text-uppercase mb-1 d-flex" for="password">Password <small class="ml-auto text-danger">(Optional)</small></label>
                            <input class="form-control form-control-lg" name="password" type="password">
                            @error('password')<span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                        <div class="col-lg-6 form-group mt-4">
                            <label class="text-small text-uppercase mb-1 d-flex" for="password_confirmation">Re-Password <small class="ml-auto text-danger">(Optional)</small></label>
                            <input class="form-control form-control-lg" name="password_confirmation" type="password">
                            @error('password_confirmation')<span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                        <div class="col-lg-12 form-group mt-4">
                            <label class="text-small text-uppercase mb-1" for="user_image">Image</label>
