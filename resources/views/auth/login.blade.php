        ...
        <div class="row">
          <div class="col-12 mt-3">
            <div class="form-group">
              <label class="text-small text-uppercase pb-2" for="email">Username</label>
              <input class="form-control form-control-lg" name="email" type="text" value="{{ old('email') }}" placeholder="Enter your first name">
              @error('email')<span class="text-danger">{{ $message }}</span>@enderror
            </div>
          </div>
          <div class="col-12 mt-3">
            <div class="form-group">
              <label class="text-small text-uppercase pb-2" for="password">Password</label>
