        ...
        <div class="row">
          <div class="col-12">
            <div class="form-group">
              <label class="text-small text-uppercase pb-2 py-4" for="first_name">First Name</label>
          ...
          <div class="col-12">
            <div class="form-group">
              <label class="text-small text-uppercase pb-2 py-4" for="last_name">Last Name</label>
          ...
          <div class="col-12">
            <div class="form-group">
              <label class="text-small text-uppercase pb-2 py-4" for="username">Username</label>
          ...
          <div class="col-12">
            <div class="form-group">
              <label class="text-small text-uppercase pb-2 py-4" for="email">E-mail Address</label>
          ...
          <div class="col-12">
            <div class="form-group">
              <label class="text-small text-uppercase pb-2 py-4" for="mobile">Mobile Number</label>
          ...
          <div class="col-12">
            <div class="form-group">
              <label class="text-small text-uppercase pb-2 py-4" for="password">Password</label>
          ...
          <div class="col-12">
            <div class="form-group">
              <label class="text-small text-uppercase pb-2 py-4" for="password_confirmation">Password</label>
